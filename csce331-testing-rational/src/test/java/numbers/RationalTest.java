...
public class RationalTest
    ...
    public void testToByteValuePositive() {
        Rational value1 = new Rational(Byte.MAX_VALUE);
        Rational value2 = new Rational(Byte.MAX_VALUE, 3);
        Rational value3 = new Rational();

        assertThat("Byte conversion: 127/1 -> 127", value1.byteValue(), is((byte) Byte.MAX_VALUE));
        assertThat("Byte conversion: 127/3 -> 42", value2.byteValue(), is((byte) (Byte.MAX_VALUE / 3)));
        assertThat("Byte conversion: 0 -> 0", value3.byteValue(), is((byte) 0));

    }

    public void testToByteValueNegative() {
        Rational value1 = new Rational(Byte.MIN_VALUE);
        Rational value2 = new Rational(Byte.MIN_VALUE, 3);

        assertThat("Byte conversion: -128/1 -> -128", value1.byteValue(), is((byte) Byte.MIN_VALUE));
        assertThat("Byte conversion: -128/3 -> -42", value2.byteValue(), is((byte) (Byte.MIN_VALUE / 3)));
    }

    public void testToShortPositive() {
        Rational value1 = new Rational(Short.MAX_VALUE);
        Rational value2 = new Rational(Short.MAX_VALUE, 3);
        Rational value3 = new Rational();

        assertThat("Short conversion: 32767/1 -> 32767", value1.shortValue(), is((short) Short.MAX_VALUE));
        assertThat("Short conversion: 32767/3 -> 10922", value2.shortValue(), is((short) (Short.MAX_VALUE / 3)));
        assertThat("Short conversion: 0/1 -> 0", value3.shortValue(), is((short) 0));
    }

    public void testToShortNegative() {
        Rational value1 = new Rational(Short.MIN_VALUE);
        Rational value2 = new Rational(Short.MIN_VALUE, 3);

        assertThat("Short conversion: -32768/1 -> -32768", value1.shortValue(), is((short) Short.MIN_VALUE));
        assertThat("Short conversion: -32768/3 -> -10922", value2.shortValue(), is((short) (Short.MIN_VALUE / 3)));
    }
    ...
    public void testLessThanPositiveShort() {
        Rational positiveValue = new Rational(50, 3);
        Rational negativeValue = new Rational(-50, 3);

        assertThat("50/3 = 16.66... < 50 is true", positiveValue.lessThan((short) 50), is(true));
        assertThat("50/3 = 16.66... < 15 is false", positiveValue.lessThan((short) 15), is(false));
        assertThat("50/3 = 16.66... < 16 is false", positiveValue.lessThan((short) 16), is(false));
        assertThat("50/3 = 16.66... < 17 is true", positiveValue.lessThan((short) 17), is(true));

        assertThat("-50/3 = -16.66... < 50 is true", negativeValue.lessThan((short) 50), is(true));
        assertThat("-50/3 = -16.66... < 15 is true", negativeValue.lessThan((short) 15), is(true));
        assertThat("-50/3 = -16.66... < 16 is true", negativeValue.lessThan((short) 16), is(true));
        assertThat("-50/3 = -16.66... < 17 is true", negativeValue.lessThan((short) 17), is(true));
    }

    public void testLessThanNegativeShort() {
        Rational positiveValue = new Rational(50, 3);
        Rational negativeValue = new Rational(-50, 3);

        assertThat("50/3 = 16.66... < -50 is false", positiveValue.lessThan((short) -50), is(false));
        assertThat("50/3 = 16.66... < -15 is false", positiveValue.lessThan((short) -15), is(false));
        assertThat("50/3 = 16.66... < -16 is false", positiveValue.lessThan((short) -16), is(false));
        assertThat("50/3 = 16.66... < -17 is false", positiveValue.lessThan((short) -17), is(false));

        assertThat("-50/3 = -16.66... < -50 is false", negativeValue.lessThan((short) -50), is(false));
        assertThat("-50/3 = -16.66... < -15 is true", negativeValue.lessThan((short) -15), is(true));
        assertThat("-50/3 = -16.66... < -16 is true", negativeValue.lessThan((short) -16), is(true));
        assertThat("-50/3 = -16.66... < -17 is false", negativeValue.lessThan((short) -17), is(false));
    }

    public void testLessThanEqualShort() {
        Rational positiveValue = new Rational(50, 2);
        Rational negativeValue = new Rational(-50, 2);

        assertThat("50 / 2 = 25 < 26 is true", positiveValue.lessThan((short) 26), is(true));
        assertThat("50 / 2 = 25 < 25 is false", positiveValue.lessThan((short) 25), is(false));
        assertThat("50 / 2 = 25 < 24 is false", positiveValue.lessThan((short) 24), is(false));

        assertThat("-50 / 2 = -25 < -26 is false", negativeValue.lessThan((short) -26), is(false));
        assertThat("-50 / 2 = -25 < -25 is false", negativeValue.lessThan((short) -25), is(false));
        assertThat("-50 / 2 = -25 < -24 is true", negativeValue.lessThan((short) -24), is(true));
    }

    public void testLessThanPositiveByte() {
        Rational positiveValue = new Rational(50, 3);
        Rational negativeValue = new Rational(-50, 3);

        assertThat("50/3 = 16.66... < 50 is true", positiveValue.lessThan((byte) 50), is(true));
        assertThat("50/3 = 16.66... < 15 is false", positiveValue.lessThan((byte) 15), is(false));
        assertThat("50/3 = 16.66... < 16 is false", positiveValue.lessThan((byte) 16), is(false));
        assertThat("50/3 = 16.66... < 17 is true", positiveValue.lessThan((byte) 17), is(true));

        assertThat("-50/3 = -16.66... < 50 is true", negativeValue.lessThan((byte) 50), is(true));
        assertThat("-50/3 = -16.66... < 15 is true", negativeValue.lessThan((byte) 15), is(true));
        assertThat("-50/3 = -16.66... < 16 is true", negativeValue.lessThan((byte) 16), is(true));
        assertThat("-50/3 = -16.66... < 17 is true", negativeValue.lessThan((byte) 17), is(true));
    }

    public void testLessThanNegativeByte() {
        Rational positiveValue = new Rational(50, 3);
        Rational negativeValue = new Rational(-50, 3);

        assertThat("50/3 = 16.66... < -50 is false", positiveValue.lessThan((byte) -50), is(false));
        assertThat("50/3 = 16.66... < -15 is false", positiveValue.lessThan((byte) -15), is(false));
        assertThat("50/3 = 16.66... < -16 is false", positiveValue.lessThan((byte) -16), is(false));
        assertThat("50/3 = 16.66... < -17 is false", positiveValue.lessThan((byte) -17), is(false));

        assertThat("-50/3 = -16.66... < -50 is false", negativeValue.lessThan((byte) -50), is(false));
        assertThat("-50/3 = -16.66... < -15 is true", negativeValue.lessThan((byte) -15), is(true));
        assertThat("-50/3 = -16.66... < -16 is true", negativeValue.lessThan((byte) -16), is(true));
        assertThat("-50/3 = -16.66... < -17 is false", negativeValue.lessThan((byte) -17), is(false));
    }

    public void testLessThanEqualByte() {
        Rational positiveValue = new Rational(50, 2);
        Rational negativeValue = new Rational(-50, 2);

        assertThat("50 / 2 = 25 < 26 is true", positiveValue.lessThan((byte) 26), is(true));
        assertThat("50 / 2 = 25 < 25 is false", positiveValue.lessThan((byte) 25), is(false));
        assertThat("50 / 2 = 25 < 24 is false", positiveValue.lessThan((byte) 24), is(false));

        assertThat("-50 / 2 = -25 < -26 is false", negativeValue.lessThan((byte) -26), is(false));
        assertThat("-50 / 2 = -25 < -25 is false", negativeValue.lessThan((byte) -25), is(false));
        assertThat("-50 / 2 = -25 < -24 is true", negativeValue.lessThan((byte) -24), is(true));
    }
    ...
    public void testGreaterThanPositiveByte() {
        Rational positiveValue = new Rational(50, 3);
        Rational negativeValue = new Rational(-50, 3);

        assertThat("50/3 = 16.66... > 50 is false", positiveValue.greaterThan((byte) 50), is(false));
        assertThat("50/3 = 16.66... > 15 is true", positiveValue.greaterThan((byte) 15), is(true));
        assertThat("50/3 = 16.66... > 16 is true", positiveValue.greaterThan((byte) 16), is(true));
        assertThat("50/3 = 16.66... > 17 is false", positiveValue.greaterThan((byte) 17), is(false));

        assertThat("-50/3 = -16.66... > 50 is false", negativeValue.greaterThan((byte) 50), is(false));
        assertThat("-50/3 = -16.66... > 15 is false", negativeValue.greaterThan((byte) 15), is(false));
        assertThat("-50/3 = -16.66... > 16 is false", negativeValue.greaterThan((byte) 16), is(false));
        assertThat("-50/3 = -16.66... > 17 is false", negativeValue.greaterThan((byte) 17), is(false));
    }

    public void testGreaterThanNegativeByte() {
        Rational positiveValue = new Rational(50, 3);
        Rational negativeValue = new Rational(-50, 3);

        assertThat("50/3 = 16.66... > -50 is true", positiveValue.greaterThan((byte) -50), is(true));
        assertThat("50/3 = 16.66... > -15 is true", positiveValue.greaterThan((byte) -15), is(true));
        assertThat("50/3 = 16.66... > -16 is true", positiveValue.greaterThan((byte) -16), is(true));
        assertThat("50/3 = 16.66... > -17 is true", positiveValue.greaterThan((byte) -17), is(true));

        assertThat("-50/3 = -16.66... > -50 is true", negativeValue.greaterThan((byte) -50), is(true));
        assertThat("-50/3 = -16.66... > -15 is false", negativeValue.greaterThan((byte) -15), is(false));
        assertThat("-50/3 = -16.66... > -16 is false", negativeValue.greaterThan((byte) -16), is(false));
        assertThat("-50/3 = -16.66... > -17 is true", negativeValue.greaterThan((byte) -17), is(true));
    }

    public void testGreaterThanEqualByte() {
        Rational positiveValue = new Rational(50, 2);
        Rational negativeValue = new Rational(-50, 2);

        assertThat("50 / 2 = 25 > 26 is false", positiveValue.greaterThan((byte) 26), is(false));
        assertThat("50 / 2 = 25 > 25 is false", positiveValue.greaterThan((byte) 25), is(false));
        assertThat("50 / 2 = 25 > 24 is true", positiveValue.greaterThan((byte) 24), is(true));

        assertThat("-50 / 2 = -25 > -26 is true", negativeValue.greaterThan((byte) -26), is(true));
        assertThat("-50 / 2 = -25 > -25 is false", negativeValue.greaterThan((byte) -25), is(false));
        assertThat("-50 / 2 = -25 > -24 is false", negativeValue.greaterThan((byte) -24), is(false));
    }

    public void testGreaterThanPositiveShort() {
        Rational positiveValue = new Rational(50, 3);
        Rational negativeValue = new Rational(-50, 3);

        assertThat("50/3 = 16.66... > 50 is false", positiveValue.greaterThan((short) 50), is(false));
        assertThat("50/3 = 16.66... > 15 is true", positiveValue.greaterThan((short) 15), is(true));
        assertThat("50/3 = 16.66... > 16 is true", positiveValue.greaterThan((short) 16), is(true));
        assertThat("50/3 = 16.66... > 17 is false", positiveValue.greaterThan((short) 17), is(false));

        assertThat("-50/3 = -16.66... > 50 is false", negativeValue.greaterThan((short) 50), is(false));
        assertThat("-50/3 = -16.66... > 15 is false", negativeValue.greaterThan((short) 15), is(false));
        assertThat("-50/3 = -16.66... > 16 is false", negativeValue.greaterThan((short) 16), is(false));
        assertThat("-50/3 = -16.66... > 17 is false", negativeValue.greaterThan((short) 17), is(false));
    }

    public void testGreaterThanNegativeShort() {
        Rational positiveValue = new Rational(50, 3);
        Rational negativeValue = new Rational(-50, 3);

        assertThat("50/3 = 16.66... > -50 is true", positiveValue.greaterThan((short) -50), is(true));
        assertThat("50/3 = 16.66... > -15 is true", positiveValue.greaterThan((short) -15), is(true));
        assertThat("50/3 = 16.66... > -16 is true", positiveValue.greaterThan((short) -16), is(true));
        assertThat("50/3 = 16.66... > -17 is true", positiveValue.greaterThan((short) -17), is(true));

        assertThat("-50/3 = -16.66... > -50 is true", negativeValue.greaterThan((short) -50), is(true));
        assertThat("-50/3 = -16.66... > -15 is false", negativeValue.greaterThan((short) -15), is(false));
        assertThat("-50/3 = -16.66... > -16 is false", negativeValue.greaterThan((short) -16), is(false));
        assertThat("-50/3 = -16.66... > -17 is true", negativeValue.greaterThan((short) -17), is(true));
    }

    public void testGreaterThanEqualShort() {
        Rational positiveValue = new Rational(50, 2);
        Rational negativeValue = new Rational(-50, 2);

        assertThat("50 / 2 = 25 > 26 is false", positiveValue.greaterThan((short) 26), is(false));
        assertThat("50 / 2 = 25 > 25 is false", positiveValue.greaterThan((short) 25), is(false));
        assertThat("50 / 2 = 25 > 24 is true", positiveValue.greaterThan((short) 24), is(true));

        assertThat("-50 / 2 = -25 > -26 is true", negativeValue.greaterThan((short) -26), is(true));
        assertThat("-50 / 2 = -25 > -25 is false", negativeValue.greaterThan((short) -25), is(false));
        assertThat("-50 / 2 = -25 > -24 is false", negativeValue.greaterThan((short) -24), is(false));
    }
